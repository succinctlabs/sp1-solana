...
/// Verifies a proof generated by [`SP1ProofWithPublicValues.bytes()`].
///
/// Checks the Groth16 vkey hash embedded in the `proof` against the provided groth16 vkey.
#[inline]
pub fn verify_proof(
    proof: &[u8],
    ...
    // Compare against the groth16_proof's groth16 vkey hash.
